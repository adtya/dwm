...
static const char *colors[][3]      = {
	/*               fg				 bg				 border   */
	[SchemeNorm] = { col_foreground, col_background, col_unfocused },
	[SchemeSel]  = { col_selection,  col_cyan,       col_green },
};
